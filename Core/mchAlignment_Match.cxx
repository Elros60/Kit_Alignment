...
TFile *fClusterFile = new TFile("ClusterCheck.root","RECREATE");
TTree *fClusterTree = new TTree("TreeE","Evaluation");
Float_t fClX = 0;
Float_t fClY = 0;
Float_t fClZ = 0;
Float_t fClXp = 0;
...
void mchAlignment_Match(std::string prefix, std::string mchFileName,
  ...
  */
  ...
  fClusterTree->Branch("fClX", &fClX, "fClX/F");
  fClusterTree->Branch("fClY", &fClY, "fClY/F");
  fClusterTree->Branch("fClZ", &fClZ, "fClZ/F");
  fClusterTree->Branch("fClXp", &fClXp, "fClXp/F");
  fClusterTree->Branch("fClYp", &fClYp, "fClYp/F");
  fClusterTree->Branch("fClZp", &fClZp, "fClZp/F");
  fClusterTree->Branch("fClDetID", &fClDetID, "fClDetID/I"); 
